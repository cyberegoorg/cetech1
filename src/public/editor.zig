...
pub const tabs = @import("editor/tabs.zig");
pub const asset_preview = @import("editor/asset_preview.zig");
pub const assetdb = @import("editor/assetdb.zig");
pub const gizmo = @import("editor/gizmo.zig");
pub const inspector = @import("editor/inspector.zig");
pub const obj_buffer = @import("editor/obj_buffer.zig");
pub const tree = @import("editor/tree.zig");
