...
pub const ApiDbAPI = struct {
    ...
    pub inline fn setApi(self: Self, comptime T: type, language: []const u8, api_name: []const u8, api_ptr: *const T) !void {
    ...
    // Set or remove C API
    pub inline fn setOrRemoveCApi(self: Self, comptime T: type, api_ptr: *const T, load: bool) !void {
        if (load) {
    ...
    pub inline fn setOrRemoveApi(self: Self, comptime T: type, language: []const u8, api_name: []const u8, api_ptr: *const T, load: bool) !void {
        if (load) {
    ...
    pub inline fn setOrRemoveZigApi(self: Self, comptime T: type, api_ptr: *const T, load: bool) !void {
        if (load) {
    ...
    pub inline fn implOrRemove(self: Self, comptime T: type, impl_ptr: *const T, load: bool) !void {
        if (load) {
    ...
    // Set zig api
    pub inline fn setZigApi(self: Self, comptime T: type, api_ptr: *const T) !void {
    ...
    // Implement interface
    pub inline fn implInterface(self: Self, comptime T: type, impl_ptr: *const anyopaque) !void {
    ...
    // Remove interface
    pub inline fn removeImpl(self: Self, comptime T: type, impl_ptr: *const anyopaque) void {
    ...
    setApiOpaqueueFn: *const fn (language: []const u8, api_name: []const u8, api_ptr: *const anyopaque, api_size: usize) anyerror!void,
    ...
    implInterfaceFn: *const fn (interface_name: strid.StrId64, impl_ptr: *const anyopaque) anyerror!void,
    ...
    removeImplFn: *const fn (interface_name: strid.StrId64, impl_ptr: *const anyopaque) void,
