    ...
    pub inline fn implement(
        ...
        const Wrap = struct {
            pub fn ui_c(
                ...
                ui_tree(allocator.*, db, tab, context[0..context_n], obj, selected_obj, args) catch undefined;
            }
        };
...
pub const TreeAPI = struct {
    // Tree view
    cdbTreeView: *const fn (allocator: std.mem.Allocator, db: *cetech1.cdb.CdbDb, tab: *editor.TabO, []const cetech1.strid.StrId64, obj: cetech1.cdb.ObjId, selection: cetech1.cdb.ObjId, args: CdbTreeViewArgs) anyerror!void,
