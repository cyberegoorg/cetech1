...
pub const UiPropertiesConfigAspect = extern struct {
    ...
    pub const name_hash = strid.strId32(UiPropertiesConfigAspect.c_name);
    hide_prototype: bool = false,
};

pub const UiPropertyConfigAspect = extern struct {
    pub const c_name = "ct_ui_property_config_aspect";
    pub const name_hash = strid.strId32(UiPropertyConfigAspect.c_name);
...
pub const UiVisualPropertyConfigAspect = extern struct {
    ...
    pub const name_hash = strid.strId32(UiVisualPropertyConfigAspect.c_name);
...
pub const UiEmbedPropertyAspect = extern struct {
    ...
    pub const name_hash = strid.strId32(UiEmbedPropertyAspect.c_name);
...
pub const UiPropertyAspect = extern struct {
    ...
    pub const name_hash = strid.strId32(UiPropertyAspect.c_name);
...
pub const UiPropertiesAspect = extern struct {
    ...
    pub const name_hash = strid.strId32(UiPropertiesAspect.c_name);
