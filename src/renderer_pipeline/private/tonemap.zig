...
const public = cetech1.renderer_pipeline.tonemap;
    ...
    struct {
        pub fn init() !void {
            ...
            try shader_system.addShaderDefiniton("tonemaping", .{
                ...
                .fragment_block = .{
                    .common_block = @embedFile("shaders/tonemap/fs_tonemap_common_block.glsl"),
                    .code = @embedFile("shaders/tonemap/fs_tonemap_block.glsl"),
                },
...
pub export fn ct_load_module_tonemap(io: *const std.Io, apidb_: *const cetech1.apidb.ApiDbAPI, allocator: *const std.mem.Allocator, load: bool, reload: bool) callconv(.c) bool {
