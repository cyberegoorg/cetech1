...
const light_system = cetech1.renderer_pipeline.light_system;
...
const bloom = cetech1.renderer_pipeline.bloom;
const tonemap = cetech1.renderer_pipeline.tonemap;
...
pub export fn ct_load_module_default_render_pipeline(io: *const std.Io, apidb_: *const cetech1.apidb.ApiDbAPI, allocator: *const std.mem.Allocator, load: bool, reload: bool) callconv(.c) bool {
