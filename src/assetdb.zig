...
const TaskList = cetech1.ArrayList(cetech1.task.TaskID);
...
var _str_intern: cetech1.heap.StringInternWithLock([]const u8) = undefined;
...
const AssetRootFS = struct {
    ...
    // Tmp
    tmp_depend_array: cetech1.ArrayList(cetech1.task.TaskID) = .{},
...
pub fn init(allocator: std.mem.Allocator) !void {
    ...
    _assetio_set = .init();
    _str_intern = cetech1.heap.StringInternWithLock([]const u8).init(allocator);
