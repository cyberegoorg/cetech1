...
pub const Fatal = enum(c_int) { DebugCheck, InvalidShader, UnableToInitialize, UnableToCreateTexture, DeviceLost, Count };
...
pub const Attachment = extern struct {
    ...
    pub fn init(self: *Attachment, _handle: TextureHandle, _access: Access, _layer: u16, _numLayers: u16, _mip: u16, _resolve: u8) void {
...
pub const VertexLayout = extern struct {
    ...
    pub fn begin(self: *VertexLayout, _rendererType: RendererType) *VertexLayout {
    ...
    pub fn add(self: *VertexLayout, _attrib: Attrib, _num: u8, _type: AttribType, _normalized: bool, _asInt: bool) *VertexLayout {
    ...
    pub fn decode(self: *const VertexLayout, _attrib: Attrib, _num: [*c]u8, _type: [*c]AttribType, _normalized: [*c]bool, _asInt: [*c]bool) void {
        return bgfx_vertex_layout_decode(self, _attrib, _num, _type, _normalized, _asInt);
    }
    /// Returns `true` if VertexLayout contains attribute.
    /// <param name="_attrib">Attribute semantics. See: `bgfx::Attrib`</param>
    pub fn has(self: *const VertexLayout, _attrib: Attrib) bool {
        return bgfx_vertex_layout_has(self, _attrib);
    }
    /// Skip `_num` bytes in vertex stream.
    /// <param name="_num">Number of bytes to skip.</param>
    pub fn skip(self: *VertexLayout, _num: u8) *VertexLayout {
        return bgfx_vertex_layout_skip(self, _num);
    }
    /// End VertexLayout.
    pub fn end(self: *VertexLayout) void {
...
pub const Encoder = opaque {
    ...
    pub fn setMarker(self: ?*Encoder, _name: [*c]const u8, _len: i32) void {
    ...
    pub fn setState(self: ?*Encoder, _state: u64, _rgba: u32) void {
    ...
    pub fn setCondition(self: ?*Encoder, _handle: OcclusionQueryHandle, _visible: bool) void {
    ...
    pub fn setScissor(self: ?*Encoder, _x: u16, _y: u16, _width: u16, _height: u16) u16 {
    ...
    pub fn setScissorCached(self: ?*Encoder, _cache: u16) void {
    ...
    pub fn setTransform(self: ?*Encoder, _mtx: ?*const anyopaque, _num: u16) u32 {
    ...
    pub fn setTransformCached(self: ?*Encoder, _cache: u32, _num: u16) void {
    ...
    pub fn allocTransform(self: ?*Encoder, _transform: [*c]Transform, _num: u16) u32 {
    ...
    pub fn setUniform(self: ?*Encoder, _handle: UniformHandle, _value: ?*const anyopaque, _num: u16) void {
    ...
    pub fn setIndexBuffer(self: ?*Encoder, _handle: IndexBufferHandle, _firstIndex: u32, _numIndices: u32) void {
    ...
    /// <param name="_firstIndex">First index to render.</param>
    /// <param name="_numIndices">Number of indices to render.</param>
    pub fn setDynamicIndexBuffer(self: ?*Encoder, _handle: DynamicIndexBufferHandle, _firstIndex: u32, _numIndices: u32) void {
    ...
    /// <param name="_firstIndex">First index to render.</param>
    /// <param name="_numIndices">Number of indices to render.</param>
    pub fn setTransientIndexBuffer(self: ?*Encoder, _tib: [*c]const TransientIndexBuffer, _firstIndex: u32, _numIndices: u32) void {
    ...
    pub fn setVertexBuffer(self: ?*Encoder, _stream: u8, _handle: VertexBufferHandle, _startVertex: u32, _numVertices: u32) void {
    ...
    pub fn setVertexBufferWithLayout(self: ?*Encoder, _stream: u8, _handle: VertexBufferHandle, _startVertex: u32, _numVertices: u32, _layoutHandle: VertexLayoutHandle) void {
    ...
    /// <param name="_startVertex">First vertex to render.</param>
    /// <param name="_numVertices">Number of vertices to render.</param>
    pub fn setDynamicVertexBuffer(self: ?*Encoder, _stream: u8, _handle: DynamicVertexBufferHandle, _startVertex: u32, _numVertices: u32) void {
        return bgfx_encoder_set_dynamic_vertex_buffer(self, _stream, _handle, _startVertex, _numVertices);
    }
    pub fn setDynamicVertexBufferWithLayout(self: ?*Encoder, _stream: u8, _handle: DynamicVertexBufferHandle, _startVertex: u32, _numVertices: u32, _layoutHandle: VertexLayoutHandle) void {
    ...
    /// <param name="_startVertex">First vertex to render.</param>
    /// <param name="_numVertices">Number of vertices to render.</param>
    pub fn setTransientVertexBuffer(self: ?*Encoder, _stream: u8, _tvb: [*c]const TransientVertexBuffer, _startVertex: u32, _numVertices: u32) void {
    ...
    /// <param name="_numVertices">Number of vertices to render.</param>
    /// <param name="_layoutHandle">Vertex layout for aliasing vertex buffer. If invalid handle is used, vertex layout used for creation of vertex buffer will be used.</param>
    pub fn setTransientVertexBufferWithLayout(self: ?*Encoder, _stream: u8, _tvb: [*c]const TransientVertexBuffer, _startVertex: u32, _numVertices: u32, _layoutHandle: VertexLayoutHandle) void {
    ...
    pub fn setVertexCount(self: ?*Encoder, _numVertices: u32) void {
    ...
    pub fn setInstanceDataBuffer(self: ?*Encoder, _idb: [*c]const InstanceDataBuffer, _start: u32, _num: u32) void {
    ...
    /// <param name="_num">Number of data instances.</param>
    pub fn setInstanceDataFromVertexBuffer(self: ?*Encoder, _handle: VertexBufferHandle, _startVertex: u32, _num: u32) void {
    ...
    /// <param name="_startVertex">First instance data.</param>
    /// <param name="_num">Number of data instances.</param>
    pub fn setInstanceDataFromDynamicVertexBuffer(self: ?*Encoder, _handle: DynamicVertexBufferHandle, _startVertex: u32, _num: u32) void {
        return bgfx_encoder_set_instance_data_from_dynamic_vertex_buffer(self, _handle, _startVertex, _num);
    }
    /// Set number of instances for auto generated instances use in conjunction
    /// with gl_InstanceID.
    /// @attention Availability depends on: `BGFX_CAPS_VERTEX_ID`.
    pub fn setInstanceCount(self: ?*Encoder, _numInstances: u32) void {
    ...
    pub fn setTexture(self: ?*Encoder, _stage: u8, _sampler: UniformHandle, _handle: TextureHandle, _flags: u32) void {
    ...
    pub fn touch(self: ?*Encoder, _id: ViewId) void {
    ...
    pub fn submit(self: ?*Encoder, _id: ViewId, _program: ProgramHandle, _depth: u32, _flags: u8) void {
    ...
    /// <param name="_depth">Depth for sorting.</param>
    /// <param name="_flags">Discard or preserve states. See `BGFX_DISCARD_*`.</param>
    pub fn submitOcclusionQuery(self: ?*Encoder, _id: ViewId, _program: ProgramHandle, _occlusionQuery: OcclusionQueryHandle, _depth: u32, _flags: u8) void {
    ...
    /// <param name="_depth">Depth for sorting.</param>
    /// <param name="_flags">Discard or preserve states. See `BGFX_DISCARD_*`.</param>
    pub fn submitIndirect(self: ?*Encoder, _id: ViewId, _program: ProgramHandle, _indirectHandle: IndirectBufferHandle, _start: u32, _num: u32, _depth: u32, _flags: u8) void {
    ...
    /// <param name="_depth">Depth for sorting.</param>
    /// <param name="_flags">Discard or preserve states. See `BGFX_DISCARD_*`.</param>
    pub fn submitIndirectCount(self: ?*Encoder, _id: ViewId, _program: ProgramHandle, _indirectHandle: IndirectBufferHandle, _start: u32, _numHandle: IndexBufferHandle, _numIndex: u32, _numMax: u32, _depth: u32, _flags: u8) void {
    ...
    pub fn setComputeIndexBuffer(self: ?*Encoder, _stage: u8, _handle: IndexBufferHandle, _access: Access) void {
    ...
    /// <param name="_access">Buffer access. See `Access::Enum`.</param>
    pub fn setComputeVertexBuffer(self: ?*Encoder, _stage: u8, _handle: VertexBufferHandle, _access: Access) void {
    ...
    /// <param name="_access">Buffer access. See `Access::Enum`.</param>
    pub fn setComputeDynamicIndexBuffer(self: ?*Encoder, _stage: u8, _handle: DynamicIndexBufferHandle, _access: Access) void {
    ...
    /// <param name="_access">Buffer access. See `Access::Enum`.</param>
    pub fn setComputeDynamicVertexBuffer(self: ?*Encoder, _stage: u8, _handle: DynamicVertexBufferHandle, _access: Access) void {
    ...
    /// <param name="_access">Buffer access. See `Access::Enum`.</param>
    pub fn setComputeIndirectBuffer(self: ?*Encoder, _stage: u8, _handle: IndirectBufferHandle, _access: Access) void {
    ...
    pub fn setImage(self: ?*Encoder, _stage: u8, _handle: TextureHandle, _mip: u8, _access: Access, _format: TextureFormat) void {
    ...
    /// <param name="_flags">Discard or preserve states. See `BGFX_DISCARD_*`.</param>
    pub fn dispatch(self: ?*Encoder, _id: ViewId, _program: ProgramHandle, _numX: u32, _numY: u32, _numZ: u32, _flags: u8) void {
    ...
    /// <param name="_flags">Discard or preserve states. See `BGFX_DISCARD_*`.</param>
    pub fn dispatchIndirect(self: ?*Encoder, _id: ViewId, _program: ProgramHandle, _indirectHandle: IndirectBufferHandle, _start: u32, _num: u32, _flags: u8) void {
        return bgfx_encoder_dispatch_indirect(self, _id, _program, _indirectHandle, _start, _num, _flags);
    }
    /// Discard previously set state for draw or compute call.
    /// <param name="_flags">Discard or preserve states. See `BGFX_DISCARD_*`.</param>
    pub fn discard(self: ?*Encoder, _flags: u8) void {
    ...
    pub fn blit(self: ?*Encoder, _id: ViewId, _dst: TextureHandle, _dstMip: u8, _dstX: u16, _dstY: u16, _dstZ: u16, _src: TextureHandle, _srcMip: u8, _srcX: u16, _srcY: u16, _srcZ: u16, _width: u16, _height: u16, _depth: u16) void {
...
pub fn vertexPack(_input: [4]f32, _inputNormalized: bool, _attr: Attrib, _layout: [*c]const VertexLayout, _data: ?*anyopaque, _index: u32) void {
    return bgfx_vertex_pack(&_input, _inputNormalized, _attr, _layout, _data, _index);
}
extern fn bgfx_vertex_pack(_input: [*c]const f32, _inputNormalized: bool, _attr: Attrib, _layout: [*c]const VertexLayout, _data: ?*anyopaque, _index: u32) void;
...
pub fn vertexUnpack(_output: [4]f32, _attr: Attrib, _layout: [*c]const VertexLayout, _data: ?*const anyopaque, _index: u32) void {
    return bgfx_vertex_unpack(&_output, _attr, _layout, _data, _index);
}
extern fn bgfx_vertex_unpack(_output: [*c]const f32, _attr: Attrib, _layout: [*c]const VertexLayout, _data: ?*const anyopaque, _index: u32) void;
...
pub fn vertexConvert(_dstLayout: [*c]const VertexLayout, _dstData: ?*anyopaque, _srcLayout: [*c]const VertexLayout, _srcData: ?*const anyopaque, _num: u32) void {
...
pub fn weldVertices(_output: ?*anyopaque, _layout: [*c]const VertexLayout, _data: ?*const anyopaque, _num: u32, _index32: bool, _epsilon: f32) u32 {
...
/// <param name="_index32">Set to `true` if input indices are 32-bit.</param>
pub fn topologyConvert(_conversion: TopologyConvert, _dst: ?*anyopaque, _dstSize: u32, _indices: ?*const anyopaque, _numIndices: u32, _index32: bool) u32 {
...
/// <param name="_numIndices">Number of input indices.</param>
/// <param name="_index32">Set to `true` if input indices are 32-bit.</param>
pub fn topologySortTriList(_sort: TopologySort, _dst: ?*anyopaque, _dstSize: u32, _dir: [3]f32, _pos: [3]f32, _vertices: ?*const anyopaque, _stride: u32, _indices: ?*const anyopaque, _numIndices: u32, _index32: bool) void {
    return bgfx_topology_sort_tri_list(_sort, _dst, _dstSize, &_dir, &_pos, _vertices, _stride, _indices, _numIndices, _index32);
}
extern fn bgfx_topology_sort_tri_list(_sort: TopologySort, _dst: ?*anyopaque, _dstSize: u32, _dir: [*c]const f32, _pos: [*c]const f32, _vertices: ?*const anyopaque, _stride: u32, _indices: ?*const anyopaque, _numIndices: u32, _index32: bool) void;
...
pub fn getSupportedRenderers(_max: u8, _enum: [*c]RendererType) u8 {
...
pub fn getRendererName(_type: RendererType) [*c]const u8 {
...
pub fn initCtor(_init: [*c]Init) void {
...
pub fn init(_init: [*c]const Init) bool {
...
/// <param name="_format">Texture format. See: `TextureFormat::Enum`.</param>
pub fn reset(_width: u32, _height: u32, _flags: u32, _format: TextureFormat) void {
...
pub fn frame(_capture: bool) u32 {
...
pub fn getRendererType() RendererType {
...
pub fn alloc(_size: u32) [*c]const Memory {
...
pub fn copy(_data: ?*const anyopaque, _size: u32) [*c]const Memory {
...
pub fn makeRef(_data: ?*const anyopaque, _size: u32) [*c]const Memory {
...
pub fn makeRefRelease(_data: ?*const anyopaque, _size: u32, _releaseFn: ?*anyopaque, _userData: ?*anyopaque) [*c]const Memory {
...
pub fn setDebug(_debug: u32) void {
...
pub fn dbgTextClear(_attr: u8, _small: bool) void {
...
pub fn dbgTextImage(_x: u16, _y: u16, _width: u16, _height: u16, _data: ?*const anyopaque, _pitch: u16) void {
...
pub fn createIndexBuffer(_mem: [*c]const Memory, _flags: u16) IndexBufferHandle {
...
pub fn setIndexBufferName(_handle: IndexBufferHandle, _name: [*c]const u8, _len: i32) void {
...
/// <param name="_handle">Static index buffer handle.</param>
pub fn destroyIndexBuffer(_handle: IndexBufferHandle) void {
...
pub fn createVertexLayout(_layout: [*c]const VertexLayout) VertexLayoutHandle {
...
pub fn destroyVertexLayout(_layoutHandle: VertexLayoutHandle) void {
...
/// <param name="_layout">Vertex layout.</param>
/// <param name="_flags">Buffer creation flags.  - `BGFX_BUFFER_NONE` - No flags.  - `BGFX_BUFFER_COMPUTE_READ` - Buffer will be read from by compute shader.  - `BGFX_BUFFER_COMPUTE_WRITE` - Buffer will be written into by compute shader. When buffer      is created with `BGFX_BUFFER_COMPUTE_WRITE` flag it cannot be updated from CPU.  - `BGFX_BUFFER_COMPUTE_READ_WRITE` - Buffer will be used for read/write by compute shader.  - `BGFX_BUFFER_ALLOW_RESIZE` - Buffer will resize on buffer update if a different amount of      data is passed. If this flag is not specified, and more data is passed on update, the buffer      will be trimmed to fit the existing buffer size. This flag has effect only on dynamic buffers.  - `BGFX_BUFFER_INDEX32` - Buffer is using 32-bit indices. This flag has effect only on index buffers.</param>
pub fn createVertexBuffer(_mem: [*c]const Memory, _layout: [*c]const VertexLayout, _flags: u16) VertexBufferHandle {
...
pub fn setVertexBufferName(_handle: VertexBufferHandle, _name: [*c]const u8, _len: i32) void {
...
/// <param name="_handle">Static vertex buffer handle.</param>
pub fn destroyVertexBuffer(_handle: VertexBufferHandle) void {
...
/// <param name="_flags">Buffer creation flags.   - `BGFX_BUFFER_NONE` - No flags.   - `BGFX_BUFFER_COMPUTE_READ` - Buffer will be read from by compute shader.   - `BGFX_BUFFER_COMPUTE_WRITE` - Buffer will be written into by compute shader. When buffer       is created with `BGFX_BUFFER_COMPUTE_WRITE` flag it cannot be updated from CPU.   - `BGFX_BUFFER_COMPUTE_READ_WRITE` - Buffer will be used for read/write by compute shader.   - `BGFX_BUFFER_ALLOW_RESIZE` - Buffer will resize on buffer update if a different amount of       data is passed. If this flag is not specified, and more data is passed on update, the buffer       will be trimmed to fit the existing buffer size. This flag has effect only on dynamic       buffers.   - `BGFX_BUFFER_INDEX32` - Buffer is using 32-bit indices. This flag has effect only on       index buffers.</param>
pub fn createDynamicIndexBuffer(_num: u32, _flags: u16) DynamicIndexBufferHandle {
...
/// <param name="_mem">Index buffer data.</param>
/// <param name="_flags">Buffer creation flags.   - `BGFX_BUFFER_NONE` - No flags.   - `BGFX_BUFFER_COMPUTE_READ` - Buffer will be read from by compute shader.   - `BGFX_BUFFER_COMPUTE_WRITE` - Buffer will be written into by compute shader. When buffer       is created with `BGFX_BUFFER_COMPUTE_WRITE` flag it cannot be updated from CPU.   - `BGFX_BUFFER_COMPUTE_READ_WRITE` - Buffer will be used for read/write by compute shader.   - `BGFX_BUFFER_ALLOW_RESIZE` - Buffer will resize on buffer update if a different amount of       data is passed. If this flag is not specified, and more data is passed on update, the buffer       will be trimmed to fit the existing buffer size. This flag has effect only on dynamic       buffers.   - `BGFX_BUFFER_INDEX32` - Buffer is using 32-bit indices. This flag has effect only on       index buffers.</param>
pub fn createDynamicIndexBufferMem(_mem: [*c]const Memory, _flags: u16) DynamicIndexBufferHandle {
...
/// <param name="_mem">Index buffer data.</param>
pub fn updateDynamicIndexBuffer(_handle: DynamicIndexBufferHandle, _startIndex: u32, _mem: [*c]const Memory) void {
...
/// <param name="_handle">Dynamic index buffer handle.</param>
pub fn destroyDynamicIndexBuffer(_handle: DynamicIndexBufferHandle) void {
...
/// <param name="_layout">Vertex layout.</param>
/// <param name="_flags">Buffer creation flags.   - `BGFX_BUFFER_NONE` - No flags.   - `BGFX_BUFFER_COMPUTE_READ` - Buffer will be read from by compute shader.   - `BGFX_BUFFER_COMPUTE_WRITE` - Buffer will be written into by compute shader. When buffer       is created with `BGFX_BUFFER_COMPUTE_WRITE` flag it cannot be updated from CPU.   - `BGFX_BUFFER_COMPUTE_READ_WRITE` - Buffer will be used for read/write by compute shader.   - `BGFX_BUFFER_ALLOW_RESIZE` - Buffer will resize on buffer update if a different amount of       data is passed. If this flag is not specified, and more data is passed on update, the buffer       will be trimmed to fit the existing buffer size. This flag has effect only on dynamic       buffers.   - `BGFX_BUFFER_INDEX32` - Buffer is using 32-bit indices. This flag has effect only on       index buffers.</param>
pub fn createDynamicVertexBuffer(_num: u32, _layout: [*c]const VertexLayout, _flags: u16) DynamicVertexBufferHandle {
...
/// <param name="_layout">Vertex layout.</param>
/// <param name="_flags">Buffer creation flags.   - `BGFX_BUFFER_NONE` - No flags.   - `BGFX_BUFFER_COMPUTE_READ` - Buffer will be read from by compute shader.   - `BGFX_BUFFER_COMPUTE_WRITE` - Buffer will be written into by compute shader. When buffer       is created with `BGFX_BUFFER_COMPUTE_WRITE` flag it cannot be updated from CPU.   - `BGFX_BUFFER_COMPUTE_READ_WRITE` - Buffer will be used for read/write by compute shader.   - `BGFX_BUFFER_ALLOW_RESIZE` - Buffer will resize on buffer update if a different amount of       data is passed. If this flag is not specified, and more data is passed on update, the buffer       will be trimmed to fit the existing buffer size. This flag has effect only on dynamic       buffers.   - `BGFX_BUFFER_INDEX32` - Buffer is using 32-bit indices. This flag has effect only on       index buffers.</param>
pub fn createDynamicVertexBufferMem(_mem: [*c]const Memory, _layout: [*c]const VertexLayout, _flags: u16) DynamicVertexBufferHandle {
...
/// <param name="_mem">Vertex buffer data.</param>
pub fn updateDynamicVertexBuffer(_handle: DynamicVertexBufferHandle, _startVertex: u32, _mem: [*c]const Memory) void {
...
/// <param name="_handle">Dynamic vertex buffer handle.</param>
pub fn destroyDynamicVertexBuffer(_handle: DynamicVertexBufferHandle) void {
...
pub fn getAvailTransientIndexBuffer(_num: u32, _index32: bool) u32 {
...
/// <param name="_layout">Vertex layout.</param>
pub fn getAvailTransientVertexBuffer(_num: u32, _layout: [*c]const VertexLayout) u32 {
...
pub fn getAvailInstanceDataBuffer(_num: u32, _stride: u16) u32 {
...
/// <param name="_index32">Set to `true` if input indices will be 32-bit.</param>
pub fn allocTransientIndexBuffer(_tib: [*c]TransientIndexBuffer, _num: u32, _index32: bool) void {
...
/// <param name="_layout">Vertex layout.</param>
pub fn allocTransientVertexBuffer(_tvb: [*c]TransientVertexBuffer, _num: u32, _layout: [*c]const VertexLayout) void {
...
/// <param name="_index32">Set to `true` if input indices will be 32-bit.</param>
pub fn allocTransientBuffers(_tvb: [*c]TransientVertexBuffer, _layout: [*c]const VertexLayout, _numVertices: u32, _tib: [*c]TransientIndexBuffer, _numIndices: u32, _index32: bool) bool {
...
pub fn allocInstanceDataBuffer(_idb: [*c]InstanceDataBuffer, _num: u32, _stride: u16) void {
...
pub fn createIndirectBuffer(_num: u32) IndirectBufferHandle {
...
/// <param name="_handle">Indirect buffer handle.</param>
pub fn destroyIndirectBuffer(_handle: IndirectBufferHandle) void {
...
pub fn createShader(_mem: [*c]const Memory) ShaderHandle {
...
pub fn getShaderUniforms(_handle: ShaderHandle, _uniforms: [*c]UniformHandle, _max: u16) u16 {
...
pub fn setShaderName(_handle: ShaderHandle, _name: [*c]const u8, _len: i32) void {
...
/// <param name="_handle">Shader handle.</param>
pub fn destroyShader(_handle: ShaderHandle) void {
...
pub fn createProgram(_vsh: ShaderHandle, _fsh: ShaderHandle, _destroyShaders: bool) ProgramHandle {
...
/// <param name="_destroyShaders">If true, shaders will be destroyed when program is destroyed.</param>
pub fn createComputeProgram(_csh: ShaderHandle, _destroyShaders: bool) ProgramHandle {
...
pub fn destroyProgram(_handle: ProgramHandle) void {
...
pub fn isTextureValid(_depth: u16, _cubeMap: bool, _numLayers: u16, _format: TextureFormat, _flags: u64) bool {
...
pub fn isFrameBufferValid(_num: u8, _attachment: [*c]const Attachment) bool {
...
/// <param name="_numLayers">Number of layers in texture array.</param>
/// <param name="_format">Texture format. See: `TextureFormat::Enum`.</param>
pub fn calcTextureSize(_info: [*c]TextureInfo, _width: u16, _height: u16, _depth: u16, _cubeMap: bool, _hasMips: bool, _numLayers: u16, _format: TextureFormat) void {
...
pub fn createTexture(_mem: [*c]const Memory, _flags: u64, _skip: u8, _info: [*c]TextureInfo) TextureHandle {
...
pub fn createTexture2D(_width: u16, _height: u16, _hasMips: bool, _numLayers: u16, _format: TextureFormat, _flags: u64, _mem: [*c]const Memory) TextureHandle {
...
/// <param name="_format">Texture format. See: `TextureFormat::Enum`.</param>
/// <param name="_flags">Texture creation (see `BGFX_TEXTURE_*`.), and sampler (see `BGFX_SAMPLER_*`) flags. Default texture sampling mode is linear, and wrap mode is repeat. - `BGFX_SAMPLER_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp to edge wrap   mode. - `BGFX_SAMPLER_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic   sampling.</param>
pub fn createTexture2DScaled(_ratio: BackbufferRatio, _hasMips: bool, _numLayers: u16, _format: TextureFormat, _flags: u64) TextureHandle {
...
/// <param name="_flags">Texture creation (see `BGFX_TEXTURE_*`.), and sampler (see `BGFX_SAMPLER_*`) flags. Default texture sampling mode is linear, and wrap mode is repeat. - `BGFX_SAMPLER_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp to edge wrap   mode. - `BGFX_SAMPLER_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic   sampling.</param>
/// <param name="_mem">Texture data. If `_mem` is non-NULL, created texture will be immutable. If `_mem` is NULL content of the texture is uninitialized. When `_numLayers` is more than 1, expected memory layout is texture and all mips together for each array element.</param>
pub fn createTexture3D(_width: u16, _height: u16, _depth: u16, _hasMips: bool, _format: TextureFormat, _flags: u64, _mem: [*c]const Memory) TextureHandle {
...
/// <param name="_flags">Texture creation (see `BGFX_TEXTURE_*`.), and sampler (see `BGFX_SAMPLER_*`) flags. Default texture sampling mode is linear, and wrap mode is repeat. - `BGFX_SAMPLER_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp to edge wrap   mode. - `BGFX_SAMPLER_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic   sampling.</param>
/// <param name="_mem">Texture data. If `_mem` is non-NULL, created texture will be immutable. If `_mem` is NULL content of the texture is uninitialized. When `_numLayers` is more than 1, expected memory layout is texture and all mips together for each array element.</param>
pub fn createTextureCube(_size: u16, _hasMips: bool, _numLayers: u16, _format: TextureFormat, _flags: u64, _mem: [*c]const Memory) TextureHandle {
...
pub fn updateTexture2D(_handle: TextureHandle, _layer: u16, _mip: u8, _x: u16, _y: u16, _width: u16, _height: u16, _mem: [*c]const Memory, _pitch: u16) void {
...
/// <param name="_mem">Texture update data.</param>
pub fn updateTexture3D(_handle: TextureHandle, _mip: u8, _x: u16, _y: u16, _z: u16, _width: u16, _height: u16, _depth: u16, _mem: [*c]const Memory) void {
...
/// <param name="_mem">Texture update data.</param>
/// <param name="_pitch">Pitch of input image (bytes). When _pitch is set to UINT16_MAX, it will be calculated internally based on _width.</param>
pub fn updateTextureCube(_handle: TextureHandle, _layer: u16, _side: u8, _mip: u8, _x: u16, _y: u16, _width: u16, _height: u16, _mem: [*c]const Memory, _pitch: u16) void {
...
/// <param name="_mip">Mip level.</param>
pub fn readTexture(_handle: TextureHandle, _data: ?*anyopaque, _mip: u8) u32 {
...
pub fn setTextureName(_handle: TextureHandle, _name: [*c]const u8, _len: i32) void {
...
/// <param name="_handle">Texture handle.</param>
pub fn getDirectAccessPtr(_handle: TextureHandle) ?*anyopaque {
...
/// Destroy texture.
/// <param name="_handle">Texture handle.</param>
pub fn destroyTexture(_handle: TextureHandle) void {
...
pub fn createFrameBuffer(_width: u16, _height: u16, _format: TextureFormat, _textureFlags: u64) FrameBufferHandle {
...
/// <param name="_format">Texture format. See: `TextureFormat::Enum`.</param>
/// <param name="_textureFlags">Texture creation (see `BGFX_TEXTURE_*`.), and sampler (see `BGFX_SAMPLER_*`) flags. Default texture sampling mode is linear, and wrap mode is repeat. - `BGFX_SAMPLER_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp to edge wrap   mode. - `BGFX_SAMPLER_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic   sampling.</param>
pub fn createFrameBufferScaled(_ratio: BackbufferRatio, _format: TextureFormat, _textureFlags: u64) FrameBufferHandle {
...
pub fn createFrameBufferFromHandles(_num: u8, _handles: [*c]const TextureHandle, _destroyTexture: bool) FrameBufferHandle {
...
/// <param name="_attachment">Attachment texture info. See: `bgfx::Attachment`.</param>
/// <param name="_destroyTexture">If true, textures will be destroyed when frame buffer is destroyed.</param>
pub fn createFrameBufferFromAttachment(_num: u8, _attachment: [*c]const Attachment, _destroyTexture: bool) FrameBufferHandle {
...
pub fn createFrameBufferFromNwh(_nwh: ?*anyopaque, _width: u16, _height: u16, _format: TextureFormat, _depthFormat: TextureFormat) FrameBufferHandle {
...
pub fn setFrameBufferName(_handle: FrameBufferHandle, _name: [*c]const u8, _len: i32) void {
...
/// <param name="_handle">Frame buffer handle.</param>
pub fn getTexture(_handle: FrameBufferHandle, _attachment: u8) TextureHandle {
...
/// <param name="_handle">Frame buffer handle.</param>
pub fn destroyFrameBuffer(_handle: FrameBufferHandle) void {
...
pub fn createUniform(_name: [*c]const u8, _type: UniformType, _num: u16) UniformHandle {
...
pub fn getUniformInfo(_handle: UniformHandle, _info: [*c]UniformInfo) void {
...
/// <param name="_handle">Handle to uniform object.</param>
pub fn destroyUniform(_handle: UniformHandle) void {
    return bgfx_destroy_uniform(_handle);
}
extern fn bgfx_destroy_uniform(_handle: UniformHandle) void;

/// Create occlusion query.
pub fn createOcclusionQuery() OcclusionQueryHandle {
...
pub fn getResult(_handle: OcclusionQueryHandle, _result: [*c]i32) OcclusionQueryResult {
...
/// <param name="_handle">Handle to occlusion query object.</param>
pub fn destroyOcclusionQuery(_handle: OcclusionQueryHandle) void {
...
pub fn setPaletteColor(_index: u8, _rgba: [4]f32) void {
    return bgfx_set_palette_color(_index, &_rgba);
}
extern fn bgfx_set_palette_color(_index: u8, _rgba: [*c]const f32) void;

/// Set palette color value.
/// <param name="_index">Index into palette.</param>
/// <param name="_rgba">Packed 32-bit RGBA value.</param>
pub fn setPaletteColorRgba8(_index: u8, _rgba: u32) void {
...
pub fn setViewName(_id: ViewId, _name: [*c]const u8, _len: i32) void {
...
pub fn setViewRect(_id: ViewId, _x: u16, _y: u16, _width: u16, _height: u16) void {
...
pub fn setViewRectRatio(_id: ViewId, _x: u16, _y: u16, _ratio: BackbufferRatio) void {
...
/// <param name="_width">Width of view scissor region.</param>
/// <param name="_height">Height of view scissor region.</param>
pub fn setViewScissor(_id: ViewId, _x: u16, _y: u16, _width: u16, _height: u16) void {
...
pub fn setViewClear(_id: ViewId, _flags: u16, _rgba: u32, _depth: f32, _stencil: u8) void {
...
pub fn setViewClearMrt(_id: ViewId, _flags: u16, _depth: f32, _stencil: u8, _c0: u8, _c1: u8, _c2: u8, _c3: u8, _c4: u8, _c5: u8, _c6: u8, _c7: u8) void {
...
pub fn setViewMode(_id: ViewId, _mode: ViewMode) void {
...
pub fn setViewFrameBuffer(_id: ViewId, _handle: FrameBufferHandle) void {
...
pub fn setViewTransform(_id: ViewId, _view: ?*const anyopaque, _proj: ?*const anyopaque) void {
...
pub fn setViewOrder(_id: ViewId, _num: u16, _order: [*c]const ViewId) void {
...
pub fn resetView(_id: ViewId) void {
...
pub fn encoderBegin(_forThread: bool) ?*Encoder {
...
pub fn encoderEnd(_encoder: ?*Encoder) void {
...
pub fn requestScreenShot(_handle: FrameBufferHandle, _filePath: [*c]const u8) void {
...
pub fn renderFrame(_msecs: i32) RenderFrame {
...
pub fn setPlatformData(_data: [*c]const PlatformData) void {
...
pub fn getInternalData() [*c]const InternalData {
...
pub fn overrideInternalTexturePtr(_handle: TextureHandle, _ptr: usize) usize {
...
/// <param name="_format">Texture format. See: `TextureFormat::Enum`.</param>
/// <param name="_flags">Texture creation (see `BGFX_TEXTURE_*`.), and sampler (see `BGFX_SAMPLER_*`) flags. Default texture sampling mode is linear, and wrap mode is repeat. - `BGFX_SAMPLER_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp to edge wrap   mode. - `BGFX_SAMPLER_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic   sampling.</param>
pub fn overrideInternalTexture(_handle: TextureHandle, _width: u16, _height: u16, _numMips: u8, _format: TextureFormat, _flags: u64) usize {
...
/// <param name="_name">Marker name.</param>
/// <param name="_len">Marker name length (if length is INT32_MAX, it's expected that _name is zero terminated string.</param>
pub fn setMarker(_name: [*c]const u8, _len: i32) void {
...
/// <param name="_state">State flags. Default state for primitive type is   triangles. See: `BGFX_STATE_DEFAULT`.   - `BGFX_STATE_DEPTH_TEST_*` - Depth test function.   - `BGFX_STATE_BLEND_*` - See remark 1 about BGFX_STATE_BLEND_FUNC.   - `BGFX_STATE_BLEND_EQUATION_*` - See remark 2.   - `BGFX_STATE_CULL_*` - Backface culling mode.   - `BGFX_STATE_WRITE_*` - Enable R, G, B, A or Z write.   - `BGFX_STATE_MSAA` - Enable hardware multisample antialiasing.   - `BGFX_STATE_PT_[TRISTRIP/LINES/POINTS]` - Primitive type.</param>
/// <param name="_rgba">Sets blend factor used by `BGFX_STATE_BLEND_FACTOR` and   `BGFX_STATE_BLEND_INV_FACTOR` blend modes.</param>
pub fn setState(_state: u64, _rgba: u32) void {
...
/// <param name="_handle">Occlusion query handle.</param>
/// <param name="_visible">Render if occlusion query is visible.</param>
pub fn setCondition(_handle: OcclusionQueryHandle, _visible: bool) void {
...
/// <param name="_width">Width of view scissor region.</param>
/// <param name="_height">Height of view scissor region.</param>
pub fn setScissor(_x: u16, _y: u16, _width: u16, _height: u16) u16 {
...
///   To scissor for all primitives in view see `bgfx::setViewScissor`.
/// <param name="_cache">Index in scissor cache.</param>
pub fn setScissorCached(_cache: u16) void {
...
/// <param name="_mtx">Pointer to first matrix in array.</param>
/// <param name="_num">Number of matrices in array.</param>
pub fn setTransform(_mtx: ?*const anyopaque, _num: u16) u32 {
...
/// <param name="_cache">Index in matrix cache.</param>
/// <param name="_num">Number of matrices from cache.</param>
pub fn setTransformCached(_cache: u32, _num: u16) void {
...
/// <param name="_transform">Pointer to `Transform` structure.</param>
/// <param name="_num">Number of matrices.</param>
pub fn allocTransform(_transform: [*c]Transform, _num: u16) u32 {
...
/// <param name="_value">Pointer to uniform data.</param>
/// <param name="_num">Number of elements. Passing `UINT16_MAX` will use the _num passed on uniform creation.</param>
pub fn setUniform(_handle: UniformHandle, _value: ?*const anyopaque, _num: u16) void {
...
/// <param name="_firstIndex">First index to render.</param>
/// <param name="_numIndices">Number of indices to render.</param>
pub fn setIndexBuffer(_handle: IndexBufferHandle, _firstIndex: u32, _numIndices: u32) void {
...
/// <param name="_firstIndex">First index to render.</param>
/// <param name="_numIndices">Number of indices to render.</param>
pub fn setDynamicIndexBuffer(_handle: DynamicIndexBufferHandle, _firstIndex: u32, _numIndices: u32) void {
...
/// <param name="_firstIndex">First index to render.</param>
/// <param name="_numIndices">Number of indices to render.</param>
pub fn setTransientIndexBuffer(_tib: [*c]const TransientIndexBuffer, _firstIndex: u32, _numIndices: u32) void {
...
/// <param name="_startVertex">First vertex to render.</param>
/// <param name="_numVertices">Number of vertices to render.</param>
pub fn setVertexBuffer(_stream: u8, _handle: VertexBufferHandle, _startVertex: u32, _numVertices: u32) void {
...
/// <param name="_numVertices">Number of vertices to render.</param>
/// <param name="_layoutHandle">Vertex layout for aliasing vertex buffer. If invalid handle is used, vertex layout used for creation of vertex buffer will be used.</param>
pub fn setVertexBufferWithLayout(_stream: u8, _handle: VertexBufferHandle, _startVertex: u32, _numVertices: u32, _layoutHandle: VertexLayoutHandle) void {
...
/// <param name="_startVertex">First vertex to render.</param>
/// <param name="_numVertices">Number of vertices to render.</param>
pub fn setDynamicVertexBuffer(_stream: u8, _handle: DynamicVertexBufferHandle, _startVertex: u32, _numVertices: u32) void {
...
/// <param name="_numVertices">Number of vertices to render.</param>
/// <param name="_layoutHandle">Vertex layout for aliasing vertex buffer. If invalid handle is used, vertex layout used for creation of vertex buffer will be used.</param>
pub fn setDynamicVertexBufferWithLayout(_stream: u8, _handle: DynamicVertexBufferHandle, _startVertex: u32, _numVertices: u32, _layoutHandle: VertexLayoutHandle) void {
...
/// <param name="_startVertex">First vertex to render.</param>
/// <param name="_numVertices">Number of vertices to render.</param>
pub fn setTransientVertexBuffer(_stream: u8, _tvb: [*c]const TransientVertexBuffer, _startVertex: u32, _numVertices: u32) void {
...
/// <param name="_numVertices">Number of vertices to render.</param>
/// <param name="_layoutHandle">Vertex layout for aliasing vertex buffer. If invalid handle is used, vertex layout used for creation of vertex buffer will be used.</param>
pub fn setTransientVertexBufferWithLayout(_stream: u8, _tvb: [*c]const TransientVertexBuffer, _startVertex: u32, _numVertices: u32, _layoutHandle: VertexLayoutHandle) void {
...
/// @attention Availability depends on: `BGFX_CAPS_VERTEX_ID`.
/// <param name="_numVertices">Number of vertices.</param>
pub fn setVertexCount(_numVertices: u32) void {
...
/// <param name="_start">First instance data.</param>
/// <param name="_num">Number of data instances.</param>
pub fn setInstanceDataBuffer(_idb: [*c]const InstanceDataBuffer, _start: u32, _num: u32) void {
...
/// <param name="_startVertex">First instance data.</param>
/// <param name="_num">Number of data instances.</param>
pub fn setInstanceDataFromVertexBuffer(_handle: VertexBufferHandle, _startVertex: u32, _num: u32) void {
...
/// <param name="_startVertex">First instance data.</param>
/// <param name="_num">Number of data instances.</param>
pub fn setInstanceDataFromDynamicVertexBuffer(_handle: DynamicVertexBufferHandle, _startVertex: u32, _num: u32) void {
...
/// with gl_InstanceID.
/// @attention Availability depends on: `BGFX_CAPS_VERTEX_ID`.
pub fn setInstanceCount(_numInstances: u32) void {
...
/// <param name="_handle">Texture handle.</param>
/// <param name="_flags">Texture sampling mode. Default value UINT32_MAX uses   texture sampling settings from the texture.   - `BGFX_SAMPLER_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp to edge wrap     mode.   - `BGFX_SAMPLER_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic     sampling.</param>
pub fn setTexture(_stage: u8, _sampler: UniformHandle, _handle: TextureHandle, _flags: u32) void {
...
pub fn submit(_id: ViewId, _program: ProgramHandle, _depth: u32, _flags: u8) void {
...
/// <param name="_depth">Depth for sorting.</param>
/// <param name="_flags">Which states to discard for next draw. See `BGFX_DISCARD_*`.</param>
pub fn submitOcclusionQuery(_id: ViewId, _program: ProgramHandle, _occlusionQuery: OcclusionQueryHandle, _depth: u32, _flags: u8) void {
...
/// <param name="_depth">Depth for sorting.</param>
/// <param name="_flags">Which states to discard for next draw. See `BGFX_DISCARD_*`.</param>
pub fn submitIndirect(_id: ViewId, _program: ProgramHandle, _indirectHandle: IndirectBufferHandle, _start: u32, _num: u32, _depth: u32, _flags: u8) void {
...
/// <param name="_depth">Depth for sorting.</param>
/// <param name="_flags">Which states to discard for next draw. See `BGFX_DISCARD_*`.</param>
pub fn submitIndirectCount(_id: ViewId, _program: ProgramHandle, _indirectHandle: IndirectBufferHandle, _start: u32, _numHandle: IndexBufferHandle, _numIndex: u32, _numMax: u32, _depth: u32, _flags: u8) void {
...
/// <param name="_handle">Index buffer handle.</param>
/// <param name="_access">Buffer access. See `Access::Enum`.</param>
pub fn setComputeIndexBuffer(_stage: u8, _handle: IndexBufferHandle, _access: Access) void {
...
/// <param name="_handle">Vertex buffer handle.</param>
/// <param name="_access">Buffer access. See `Access::Enum`.</param>
pub fn setComputeVertexBuffer(_stage: u8, _handle: VertexBufferHandle, _access: Access) void {
...
/// <param name="_handle">Dynamic index buffer handle.</param>
/// <param name="_access">Buffer access. See `Access::Enum`.</param>
pub fn setComputeDynamicIndexBuffer(_stage: u8, _handle: DynamicIndexBufferHandle, _access: Access) void {
...
/// <param name="_handle">Dynamic vertex buffer handle.</param>
/// <param name="_access">Buffer access. See `Access::Enum`.</param>
pub fn setComputeDynamicVertexBuffer(_stage: u8, _handle: DynamicVertexBufferHandle, _access: Access) void {
...
/// <param name="_handle">Indirect buffer handle.</param>
/// <param name="_access">Buffer access. See `Access::Enum`.</param>
pub fn setComputeIndirectBuffer(_stage: u8, _handle: IndirectBufferHandle, _access: Access) void {
...
/// <param name="_access">Image access. See `Access::Enum`.</param>
/// <param name="_format">Texture format. See: `TextureFormat::Enum`.</param>
pub fn setImage(_stage: u8, _handle: TextureHandle, _mip: u8, _access: Access, _format: TextureFormat) void {
...
/// <param name="_numZ">Number of groups Z.</param>
/// <param name="_flags">Discard or preserve states. See `BGFX_DISCARD_*`.</param>
pub fn dispatch(_id: ViewId, _program: ProgramHandle, _numX: u32, _numY: u32, _numZ: u32, _flags: u8) void {
...
/// <param name="_num">Number of dispatches.</param>
/// <param name="_flags">Discard or preserve states. See `BGFX_DISCARD_*`.</param>
pub fn dispatchIndirect(_id: ViewId, _program: ProgramHandle, _indirectHandle: IndirectBufferHandle, _start: u32, _num: u32, _flags: u8) void {
...
/// <param name="_height">Height of region.</param>
/// <param name="_depth">If texture is 3D this argument represents depth of region, otherwise it's unused.</param>
pub fn blit(_id: ViewId, _dst: TextureHandle, _dstMip: u8, _dstX: u16, _dstY: u16, _dstZ: u16, _src: TextureHandle, _srcMip: u8, _srcX: u16, _srcY: u16, _srcZ: u16, _width: u16, _height: u16, _depth: u16) void {
