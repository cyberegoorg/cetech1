...
const ChangedObjects = struct {
    ...
    pub fn getSince(self: *Self, allocator: std.mem.Allocator, since_version: public.TypeVersion, last_version: public.TypeVersion) ![]public.ObjId {
        ...
        var output = cetech1.ArrayList(public.ObjId){};
...
pub const TypeStorage = struct {
    ...
    fn decreaseReferenceFree(self: *Self, object: *Object, destroyed_objid: *cetech1.ArrayList(public.ObjId), allocator: std.mem.Allocator) anyerror!u32 {
        var ref_count = &self.objid_ref_count.items[object.objid.id];
    ...
    pub fn freeObject(self: *Self, obj: *Object, destroyed_objid: *cetech1.ArrayList(public.ObjId), allocator: std.mem.Allocator) !u32 {
        var zone_ctx = profiler.ztracy.Zone(@src());
        defer zone_ctx.End();
    ...
    pub fn gc(self: *Self, allocator: std.mem.Allocator) !u32 {
        ...
        var destroyed_ids = cetech1.ArrayList(public.ObjId){};
        defer destroyed_ids.deinit(allocator);

        var changed_ids = cetech1.ArrayList(public.ObjId){};
...
pub const Db = struct {
    ...
    fn readSet(self: *Self, writer: *public.Obj, prop_idx: u32, allocator: std.mem.Allocator) ![]const public.ObjId {
        ...
        var result = cetech1.ArrayList(public.ObjId){};
