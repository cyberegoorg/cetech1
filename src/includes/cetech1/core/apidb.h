...
{
    void (*set_api)(const char *language, const char *api_name, const void *api_ptr, uint32_t api_size);
    ...
    void (*impl)(ct_strid64_t interface_name, const void *impl_ptr);
    void (*remove_impl)(ct_strid64_t interface_name, const void *impl_ptr);
    void (*impl_or_remove)(ct_strid64_t interface_name, const void *impl_ptr, bool load);
