...
const public = cetech1.scripting.graphvm_script_component;
    ...
    struct {
        pub fn iterate(world: *ecs.World, it: *ecs.Iter, dt: f32) !void {
            ...
            for (0..it.count()) |idx| {
                ...
                try graphvm.setInstanceContext(instances[idx], ecs.ECS_WORLD_CONTEXT, world);
...
pub export fn ct_load_module_graphvm_script_component(io: *const std.Io, apidb_: *const cetech1.apidb.ApiDbAPI, allocator: *const std.mem.Allocator, load: bool, reload: bool) callconv(.c) bool {
