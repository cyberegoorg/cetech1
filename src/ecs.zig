...
pub fn createWorld() !public.World {
    ...
    const module = ecs_module_init(world, "cetech1", &zflecs.component_desc_t{ .entity = cetech_entity, .type = .{ .size = 0, .alignment = 0 } });
