...
pub fn registerToApi() !void {
    ...
    try apidb.api.implInterface(module_name, public.GpuBackendI, &bgfx_metal);
    try apidb.api.implInterface(module_name, public.GpuBackendI, &bgfx_vulkan);
    try apidb.api.implInterface(module_name, public.GpuBackendI, &bgfx_dx12);
    try apidb.api.implInterface(module_name, public.GpuBackendI, &bgfx_noop);
}
...
pub const backend_api = public.GpuBackendApi.implement(struct {
    ...
    pub fn alloc(self: *anyopaque, _size: u32) [*c]const public.Memory {
        _ = self;
        return @ptrCast(zbgfx.bgfx.alloc(_size));
    }
    pub fn copy(self: *anyopaque, _data: ?*const anyopaque, _size: u32) [*c]const public.Memory {
        _ = self;
        return @ptrCast(zbgfx.bgfx.copy(_data, _size));
    }
    pub fn makeRef(self: *anyopaque, _data: ?*const anyopaque, _size: u32) [*c]const public.Memory {
        _ = self;
        return @ptrCast(zbgfx.bgfx.makeRef(_data, _size));
    }
    pub fn makeRefRelease(self: *anyopaque, _data: ?*const anyopaque, _size: u32, _releaseFn: ?*anyopaque, _userData: ?*anyopaque) [*c]const public.Memory {
        _ = self;
    ...
    pub fn setIndexBufferName(self: *anyopaque, _handle: public.IndexBufferHandle, _name: [*c]const u8, _len: i32) void {
        _ = self;
        return zbgfx.bgfx.setIndexBufferName(.{ .idx = _handle.idx }, _name, _len);
    }
    ...
    pub fn createVertexLayout(self: *anyopaque, _layout: [*c]const public.VertexLayout) public.VertexLayoutHandle {
        _ = self;
    ...
    pub fn createVertexBuffer(self: *anyopaque, _mem: ?*const public.Memory, _layout: [*c]const public.VertexLayout, _flags: public.BufferFlags) public.VertexBufferHandle {
        _ = self;
        return .{ .idx = bgfx.createVertexBuffer(@ptrCast(_mem), @ptrCast(_layout), BufferFlags.toState(_flags)).idx };
    }
    pub fn setVertexBufferName(self: *anyopaque, _handle: public.VertexBufferHandle, _name: [*c]const u8, _len: i32) void {
        _ = self;
        return zbgfx.bgfx.setVertexBufferName(.{ .idx = _handle.idx }, _name, _len);
    }
    ...
    pub fn createDynamicVertexBuffer(self: *anyopaque, _num: u32, _layout: [*c]const public.VertexLayout, _flags: public.BufferFlags) public.DynamicVertexBufferHandle {
        _ = self;
        return .{ .idx = bgfx.createDynamicVertexBuffer(_num, @ptrCast(_layout), BufferFlags.toState(_flags)).idx };
    }
    pub fn createDynamicVertexBufferMem(self: *anyopaque, _mem: ?*const public.Memory, _layout: [*c]const public.VertexLayout, _flags: u16) public.DynamicVertexBufferHandle {
        _ = self;
    ...
    pub fn getAvailTransientVertexBuffer(self: *anyopaque, _num: u32, _layout: [*c]const public.VertexLayout) u32 {
        _ = self;
    ...
    pub fn allocTransientVertexBuffer(self: *anyopaque, _tvb: [*c]public.TransientVertexBuffer, _num: u32, _layout: [*c]const public.VertexLayout) void {
        _ = self;
        return zbgfx.bgfx.allocTransientVertexBuffer(@ptrCast(_tvb), _num, @ptrCast(_layout));
    }
    pub fn allocTransientBuffers(self: *anyopaque, _tvb: [*c]public.TransientVertexBuffer, _layout: [*c]const public.VertexLayout, _numVertices: u32, _tib: [*c]public.TransientIndexBuffer, _numIndices: u32, _index32: bool) bool {
        _ = self;
    ...
    pub fn setShaderName(self: *anyopaque, _handle: public.ShaderHandle, _name: [*c]const u8, _len: i32) void {
        _ = self;
        return zbgfx.bgfx.setShaderName(.{ .idx = _handle.idx }, _name, _len);
    }
    ...
    pub fn isFrameBufferValid(self: *anyopaque, _num: u8, _attachment: [*c]const public.Attachment) bool {
        _ = self;
    ...
    pub fn setTextureName(self: *anyopaque, _handle: public.TextureHandle, _name: [*c]const u8, _len: i32) void {
        _ = self;
        return zbgfx.bgfx.setTextureName(.{ .idx = _handle.idx }, _name, _len);
    }
    ...
    pub fn createFrameBufferFromHandles(self: *anyopaque, _num: u8, _handles: [*c]const public.TextureHandle, _destroyTexture: bool) public.FrameBufferHandle {
        _ = self;
        return .{ .idx = zbgfx.bgfx.createFrameBufferFromHandles(_num, @ptrCast(_handles), _destroyTexture).idx };
    }
    pub fn createFrameBufferFromAttachment(self: *anyopaque, _num: u8, _attachment: [*c]const public.Attachment, _destroyTexture: bool) public.FrameBufferHandle {
        _ = self;
        return .{ .idx = zbgfx.bgfx.createFrameBufferFromAttachment(_num, @ptrCast(_attachment), _destroyTexture).idx };
    }
    ...
    pub fn setFrameBufferName(self: *anyopaque, _handle: public.FrameBufferHandle, _name: [*c]const u8, _len: i32) void {
        _ = self;
        return zbgfx.bgfx.setFrameBufferName(.{ .idx = _handle.idx }, _name, _len);
    }
    ...
    pub fn createUniform(self: *anyopaque, _name: [*c]const u8, _type: public.UniformType, _num: u16) public.UniformHandle {
        _ = self;
        return .{ .idx = zbgfx.bgfx.createUniform(_name, @enumFromInt(@intFromEnum(_type)), _num).idx };
    }
    ...
    pub fn setViewName(self: *anyopaque, _id: public.ViewId, _name: [*c]const u8, _len: i32) void {
        _ = self;
        return zbgfx.bgfx.setViewName(_id, _name, _len);
    }
    ...
    pub fn setViewOrder(self: *anyopaque, _id: public.ViewId, _num: u16, _order: [*c]const public.ViewId) void {
        _ = self;
    ...
    pub fn layoutHas(self: *const public.VertexLayout, _attrib: public.Attrib) bool {
        return zbgfx.bgfx.VertexLayout.has(@ptrCast(self), @enumFromInt(@intFromEnum(_attrib)));
    }
    ...
    pub fn vertexPack(self: *anyopaque, _input: [4]f32, _inputNormalized: bool, _attr: public.Attrib, _layout: [*c]const public.VertexLayout, _data: ?*anyopaque, _index: u32) void {
        _ = self;
        return bgfx.vertexPack(_input, _inputNormalized, @enumFromInt(@intFromEnum(_attr)), @ptrCast(_layout), _data, _index);
    }
    pub fn vertexUnpack(self: *anyopaque, _output: [4]f32, _attr: public.Attrib, _layout: [*c]const public.VertexLayout, _data: ?*const anyopaque, _index: u32) void {
        _ = self;
        return bgfx.vertexUnpack(_output, @enumFromInt(@intFromEnum(_attr)), @ptrCast(_layout), _data, _index);
    }
    pub fn vertexConvert(self: *anyopaque, _dstLayout: [*c]const public.VertexLayout, _dstData: ?*anyopaque, _srcLayout: [*c]const public.VertexLayout, _srcData: ?*const anyopaque, _num: u32) void {
        _ = self;
        return bgfx.vertexConvert(@ptrCast(_dstLayout), _dstData, @ptrCast(_srcLayout), _srcData, _num);
    }
    pub fn weldVertices(self: *anyopaque, _output: ?*anyopaque, _layout: [*c]const public.VertexLayout, _data: ?*const anyopaque, _num: u32, _index32: bool, _epsilon: f32) u32 {
        _ = self;
...
fn initBgfx(context: *BgfxBackend, backend: bgfx.RendererType, vsync: bool, headless: bool, debug: bool, profile: bool) !void {
    ...
    context.encoders = try .initCapacity(_allocator, task.api.getThreadNum());
...
fn createBgfxBackend(
    ...
    return .{ .inst = @ptrCast(context), .api = &backend_api };
}

const encoder_vt = public.GpuEncoder.implement(struct {
    pub fn setMarker(self: *anyopaque, _name: [*c]const u8, _len: i32) void {
        const enc: *bgfx.Encoder = @ptrCast(@alignCast(self));
        return enc.setMarker(_name, _len);
    }
    ...
    pub fn setTransientIndexBuffer(self: *anyopaque, _tib: [*c]const public.TransientIndexBuffer, _firstIndex: u32, _numIndices: u32) void {
        const enc: *bgfx.Encoder = @ptrCast(@alignCast(self));
    ...
    pub fn setTransientVertexBuffer(self: *anyopaque, _stream: u8, _tvb: [*c]const public.TransientVertexBuffer, _startVertex: u32, _numVertices: u32) void {
        const enc: *bgfx.Encoder = @ptrCast(@alignCast(self));
        return enc.setTransientVertexBuffer(_stream, @ptrCast(_tvb), _startVertex, _numVertices);
    }
    pub fn setTransientVertexBufferWithLayout(self: *anyopaque, _stream: u8, _tvb: [*c]const public.TransientVertexBuffer, _startVertex: u32, _numVertices: u32, _layoutHandle: public.VertexLayoutHandle) void {
        const enc: *bgfx.Encoder = @ptrCast(@alignCast(self));
