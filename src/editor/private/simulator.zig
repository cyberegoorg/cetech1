...
const camera_controller = cetech1.camera_controller;
...
pub export fn ct_load_module_editor_simulator(io: *const std.Io, apidb_: *const cetech1.apidb.ApiDbAPI, allocator: *const std.mem.Allocator, load: bool, reload: bool) callconv(.c) bool {
