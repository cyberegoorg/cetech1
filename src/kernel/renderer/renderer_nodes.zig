...
const vertex_system = cetech1.renderer_pipeline.vertex_system;
const visibility_flags = cetech1.renderer.visibility_flags;

const public = cetech1.renderer.nodes;
    ...
    pub fn createTypes(db: cdb.DbId) !void {
        ...
        // DrawCallNodeSettings
        {
            draw_call_setttings_type_idx = try cdb.addType(
                ...
                &[_]cdb.PropDef{
                    .{
                        .prop_idx = public.DrawCallNodeSettingsCdb.propIdx(.VisibilityFlags),
