...
pub fn registerToApi() !void {
    try apidb.setZigApi(module, public.MetricsAPI, &api);
}
...
pub fn pushFrames() !void {
    ...
    for (_metric_map.values()) |idx| {
        ...
        profiler.plotF64(m.name, m.current_value);
...
const api = public.MetricsAPI{
    .getCounter = getCounter,
    .pushFrames = pushFrames,
    .getMetricsName = getMetricsName,
    .getMetricValues = getMetricValues,
    .getMetricOffset = getMetricOffset,
};
