...
var _tmp_depend_array: cetech1.ArrayList(cetech1.task.TaskID) = undefined;
...
fn sleepIfNeed(allocator: std.mem.Allocator, last_call: i64, max_rate: u32, worker_n: u64) !cetech1.task.TaskID {
    ...
    if (dt < frame_limit_time) {
        ...
        const n = worker_n;
        var wait_tasks = try cetech1.ArrayList(cetech1.task.TaskID).initCapacity(allocator, n);
