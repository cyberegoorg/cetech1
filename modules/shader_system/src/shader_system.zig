...
pub const ShaderSystemAPI = struct {
    ...
    compileShader: *const fn (allocator: std.mem.Allocator, definitons: []const strid.StrId32) anyerror!?ShaderInstance,

    getGpuProgram: *const fn (shader_instance: ShaderInstance) ?gpu.ProgramHandle,
    getState: *const fn (shader_instance: ShaderInstance) u64,
    getRGBAState: *const fn (shader_instance: ShaderInstance) u32,
};
