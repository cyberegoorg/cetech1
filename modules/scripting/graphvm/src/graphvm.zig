...
pub const GraphVMApi = struct {
    pub inline fn getNodeState(api: *const GraphVMApi, comptime T: type, allocator: std.mem.Allocator, instances: []const GraphInstance, node_type: cetech1.StrId32) ![]?*T {
    ...
    pub inline fn getContext(api: *const GraphVMApi, comptime T: type, instance: GraphInstance, context_name: cetech1.StrId32) ?*T {
