...
pub const TranspileStageMap = cetech1.AutoArrayHashMap(cetech1.StrId32, cetech1.ArrayList(u8));
...
pub const GpuTranspileState = struct {
    ...
    common_code: cetech1.ArrayList(u8) = .{},
    ...
    pub fn getWriter(self: *GpuTranspileState, context: []const u8, stage: cetech1.StrId32) !cetech1.ArrayList(u8).Writer {
