...
pub const BufferHandle = union(enum) {
    ...
    tvb: gpu.TransientVertexBuffer,
    tib: gpu.TransientIndexBuffer,
};
...
pub const ShaderSystemAPI = struct {
    ...
    compileShader: *const fn (allocator: std.mem.Allocator, use_definitions: []const cetech1.StrId32, definition: ?ShaderDefinition, name: ?cetech1.StrId32) anyerror!?Shader,
    ...
    updateUniforms: *const fn (shader: ShaderIO, uniformbuffer: UniformBufferInstance, items: []const UpdateUniformItem) anyerror!void,
    updateResources: *const fn (shader: ShaderIO, uniformbuffer: ResourceBufferInstance, items: []const UpdateResourceItem) anyerror!void,

    bindConstant: *const fn (shader_io: ShaderIO, uniformbuffer: UniformBufferInstance, encoder: gpu.Encoder) void,
    bindSystemConstant: *const fn (shader_io: ShaderIO, system: System, uniformbuffer: UniformBufferInstance, encoder: gpu.Encoder) void,

    bindResource: *const fn (shader_io: ShaderIO, uniformbuffer: ResourceBufferInstance, encoder: gpu.Encoder) void,
    bindSystemResource: *const fn (shader_io: ShaderIO, system: System, uniformbuffer: ResourceBufferInstance, encoder: gpu.Encoder) void,
};
