...
pub const ShaderSystemAPI = struct {
    ...
    bindResource: *const fn (shader_io: ShaderIO, uniform_buffer: ResourceBufferInstance, encoder: gpu.Encoder) void,
    bindSystemResource: *const fn (shader_io: ShaderIO, system: System, uniform_buffer: ResourceBufferInstance, encoder: gpu.Encoder) void,
};
