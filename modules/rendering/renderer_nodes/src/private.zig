...
var kernel_task = cetech1.kernel.KernelTaskI.implement(
    ...
    struct {
        pub fn init() !void {
            ...
            _g.cube_vb.channels[vertex_system.VertexChannelsNames.Color0].stride = @sizeOf(ColorVertex);
        ...
        pub fn execute(self: *const graphvm.NodeI, args: graphvm.ExecuteArgs, in_pins: graphvm.InPins, out_pins: *graphvm.OutPins) !void {
            ...
            switch (type_enum) {
                .cube => {
                    ...
                    try out_pins.writeTyped(u32, 3, cube_tri_strip.len, cube_tri_strip.len);
                },
