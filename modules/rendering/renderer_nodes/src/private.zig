...
var kernel_task = cetech1.kernel.KernelTaskI.implement(
    ...
    struct {
        pub fn init() !void {
            ...
            _g.cube_vb.active_channels.set(vertex_system.VertexChannelsNames.Color);
            _g.cube_vb.channels[vertex_system.VertexChannelsNames.Position].stride = 4;
            _g.cube_vb.channels[vertex_system.VertexChannelsNames.Position].stride = 4;
            _g.cube_vb.channels[vertex_system.VertexChannelsNames.Color].buffer_idx = 1;
            _g.cube_vb.channels[vertex_system.VertexChannelsNames.Color].stride = 4;

            _g.cube_geometry = try _vertex_system.createVertexSystemFromVertexBuffer(_g.cube_vb);
            ...
            _g.bunny_vb.active_channels.set(vertex_system.VertexChannelsNames.Color);
            _g.bunny_vb.channels[vertex_system.VertexChannelsNames.Position].stride = 4;
            _g.bunny_vb.channels[vertex_system.VertexChannelsNames.Position].stride = 4;
            _g.bunny_vb.channels[vertex_system.VertexChannelsNames.Color].buffer_idx = 1;
            _g.bunny_vb.channels[vertex_system.VertexChannelsNames.Color].stride = 4;

            _g.bunny_geometry = try _vertex_system.createVertexSystemFromVertexBuffer(_g.bunny_vb);
