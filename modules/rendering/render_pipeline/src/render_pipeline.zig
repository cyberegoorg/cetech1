...
pub const RenderPipeline = struct {
    ...
    pub fn begin(self: *RenderPipeline, context: *shader_system.ShaderContext, now_s: f32) !void {
        try self.vtable.begin(self.ptr, context, now_s);
    }

    pub fn end(self: *RenderPipeline, context: *shader_system.ShaderContext) !void {
...
pub const RenderPipelineI = struct {
    ...
    begin: *const fn (pipeline: *anyopaque, context: *shader_system.ShaderContext, now_s: f32) anyerror!void = undefined,
    end: *const fn (pipeline: *anyopaque, context: *shader_system.ShaderContext) anyerror!void = undefined,
