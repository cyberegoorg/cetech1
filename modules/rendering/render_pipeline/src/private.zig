...
// var _render_viewport: *const renderer.RenderViewportApi = undefined;

fn createDefault(allocator: std.mem.Allocator) !public.RenderPipeline {
    ...
    const inst = try iface.create(allocator);
    return .{
        .ptr = inst,
        .vtable = iface,
    };
