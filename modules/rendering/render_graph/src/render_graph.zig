...
pub const GraphBuilder = struct {
    ...
    pub inline fn execute(builder: GraphBuilder, allocator: std.mem.Allocator, vp_size: [2]f32, world: ecs.World, viewers: []const Viewer) !void {
        return builder.vtable.execute(builder.ptr, allocator, vp_size, world, viewers);
    }
    ...
    pub const VTable = struct {
        ...
        execute: *const fn (builder: *anyopaque, allocator: std.mem.Allocator, vp_size: [2]f32, world: ecs.World, viewers: []const Viewer) anyerror!void,
