...
pub const GraphBuilder = struct {
    pub inline fn enablePass(builder: GraphBuilder, pass: *Pass, name: []const u8) !void {
        return builder.vtable.enablePass(builder.ptr, pass, name);
    }
    ...
    pub const VTable = struct {
        enablePass: *const fn (builder: *anyopaque, pass: *Pass, name: []const u8) anyerror!void,
