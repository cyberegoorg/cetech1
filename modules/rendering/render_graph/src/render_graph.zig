...
pub const Pass = struct {
    ...
    execute: *const fn (builder: GraphBuilder, gpu_api: *const GpuApi, world: ecs.World, vp_size: [2]f32, viewid: gpu.ViewId, viewers: []const Viewer) anyerror!void,
...
pub const GraphBuilder = struct {
    ...
    pub inline fn execute(builder: GraphBuilder, vp_size: [2]f32, world: ecs.World, viewers: []const Viewer) !void {
        return builder.vtable.execute(builder.ptr, vp_size, world, viewers);
    }

    pub inline fn reset(builder: GraphBuilder) !void {
        return builder.vtable.reset(builder.ptr);
    }
    ...
    pub const VTable = struct {
        ...
        execute: *const fn (builder: *anyopaque, vp_size: [2]f32, world: ecs.World, viewers: []const Viewer) anyerror!void,

        reset: *const fn (builder: *anyopaque) anyerror!void,
    };
};
