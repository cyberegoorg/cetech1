...
pub const VertexBuffer = struct {
    ...
    num_vertices: u32 = 0,
    num_sets: u32 = 0,
    buffers: [4]gpu.VertexBufferHandle = @splat(.{}),
    channels: [16]VertexChannel = @splat(.{}),
};

pub const GPUGeometry = struct {
    vertex_system: shader_system.SystemInstance,
};
...
pub const DrawCall = struct {
    shader: shader_system.ShaderInstance,
...
pub const RenderViewportApi = struct {
    ...
    createVertexSystemFromVertexBuffer: *const fn (vertex_buffer: VertexBuffer) anyerror!shader_system.SystemInstance,
