    ...
    pub fn exec(self: *@This()) !void {
        ...
        if (viewport.world) |world| {
            ...
            // Culling shaderables
            {
                ...
                // First culling phase
                _ = try viewport.shaderables_culling.doCullingSpheres(allocator, viewers.items[0..1]);
...

            {
                ...
                // Culling renderables
                {
                    ...
                    // First culling phase
                    viewport.renderable_sphere_passed.* = @floatFromInt(try viewport.renderables_culling.doCullingSpheres(allocator, all_viewers));
