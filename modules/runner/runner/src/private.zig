...
var coreui_ui_i = coreui.CoreUII.implement(struct {
    pub fn ui(allocator: std.mem.Allocator, kernel_tick: u64, dt: f32) !void {
        ...
        if (_coreui.beginMenu(allocator, cetech1.coreui.Icons.Debug, true, null)) {
            ...
            //TODO: _g.flecs_port = _editor_entity.uiRemoteDebugMenuItems(&tab_o.world, allocator, tab_o.flecs_port);
        }
    }
});
