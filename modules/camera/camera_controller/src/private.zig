...
pub fn load_module_zig(allocator: Allocator, load: bool, reload: bool) anyerror!bool {
    ...
    try actions.loadAPI(module_name);
...
pub export fn ct_load_module_camera_controller(apidb_: *const cetech1.apidb.ApiDbAPI, allocator: *const std.mem.Allocator, load: bool, reload: bool) callconv(.c) bool {
