...
const PinHashNameMap = cetech1.AutoHashMapUnmanaged(struct { cdb.ObjId, cetech1.StrId32 }, [:0]const u8);
const PinValueTypeMap = cetech1.AutoArrayHashMap(struct { cdb.ObjId, cetech1.StrId32 }, cetech1.StrId32);
const PinDataMap = cetech1.AutoHashMapUnmanaged(struct { cdb.ObjId, cetech1.StrId32 }, cdb.ObjId);

const ToFromConMap = cetech1.AutoHashMapUnmanaged(struct { cdb.ObjId, cetech1.StrId32 }, struct { cdb.ObjId, cetech1.StrId32 });
