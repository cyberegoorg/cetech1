...
pub const GpuPresentI = extern struct {
    ...
    present: *const fn (kernel_tick: u64, dt: f32) callconv(.C) void,
    ...
    pub inline fn implement(
        ...
        return GpuPresentI{
            .present = struct {
                pub fn f(kernel_tick: u64, dt: f32) callconv(.C) void {
                    T.present(kernel_tick, dt) catch |err| {
...
pub const GpuApi = struct {
    ...
    shitTempRender: *const fn (ctx: *GpuContext, kernel_tick: u64, dt: f32) void,
};
