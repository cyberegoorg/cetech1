...
pub const GpuBackend = struct {
    ...
    pub fn createDefaultOptionsForRenderer(self: GpuBackend) ShadercOptions {
        return self.api.createDefaultOptionsForRenderer(
            self.inst,
        );
    }
    pub fn isHomogenousDepth(self: GpuBackend) bool {
        return self.api.isHomogenousDepth(
            self.inst,
        );
    }
    pub fn getNullVb(self: GpuBackend) VertexBufferHandle {
        return self.api.getNullVb(
            self.inst,
        );
    }
    pub fn getFloatBufferLayout(self: GpuBackend) *const VertexLayout {
        return self.api.getFloatBufferLayout(
            self.inst,
        );
    }
    ...
    pub fn alloc(self: GpuBackend, _size: u32) [*c]const Memory {
        return self.api.alloc(self.inst, _size);
    }
    pub fn copy(self: GpuBackend, _data: ?*const anyopaque, _size: u32) [*c]const Memory {
        return self.api.copy(self.inst, _data, _size);
    }
    pub fn makeRef(self: GpuBackend, _data: ?*const anyopaque, _size: u32) [*c]const Memory {
        return self.api.makeRef(self.inst, _data, _size);
    }
    pub fn makeRefRelease(self: GpuBackend, _data: ?*const anyopaque, _size: u32, _releaseFn: ?*anyopaque, _userData: ?*anyopaque) [*c]const Memory {
    ...
    pub fn setIndexBufferName(self: GpuBackend, _handle: IndexBufferHandle, _name: [*c]const u8, _len: i32) void {
        return self.api.setIndexBufferName(self.inst, _handle, _name, _len);
    }
    ...
    pub fn createVertexLayout(self: GpuBackend, _layout: [*c]const VertexLayout) VertexLayoutHandle {
    ...
    pub fn createVertexBuffer(self: GpuBackend, _mem: ?*const Memory, _layout: [*c]const VertexLayout, _flags: BufferFlags) VertexBufferHandle {
        return self.api.createVertexBuffer(self.inst, _mem, _layout, _flags);
    }
    pub fn setVertexBufferName(self: GpuBackend, _handle: VertexBufferHandle, _name: [*c]const u8, _len: i32) void {
    ...
    pub fn createDynamicVertexBuffer(self: GpuBackend, _num: u32, _layout: [*c]const VertexLayout, _flags: BufferFlags) DynamicVertexBufferHandle {
        return self.api.createDynamicVertexBuffer(self.inst, _num, _layout, _flags);
    }
    pub fn createDynamicVertexBufferMem(self: GpuBackend, _mem: ?*const Memory, _layout: [*c]const VertexLayout, _flags: u16) DynamicVertexBufferHandle {
    ...
    pub fn getAvailTransientVertexBuffer(self: GpuBackend, _num: u32, _layout: [*c]const VertexLayout) u32 {
    ...
    pub fn allocTransientVertexBuffer(self: GpuBackend, _tvb: [*c]TransientVertexBuffer, _num: u32, _layout: [*c]const VertexLayout) void {
        return self.api.allocTransientVertexBuffer(self.inst, _tvb, _num, _layout);
    }
    pub fn allocTransientBuffers(self: GpuBackend, _tvb: [*c]TransientVertexBuffer, _layout: [*c]const VertexLayout, _numVertices: u32, _tib: [*c]TransientIndexBuffer, _numIndices: u32, _index32: bool) bool {
    ...
    pub fn setShaderName(self: GpuBackend, _handle: ShaderHandle, _name: [*c]const u8, _len: i32) void {
        return self.api.setShaderName(self.inst, _handle, _name, _len);
    }
    ...
    pub fn isFrameBufferValid(self: GpuBackend, _num: u8, _attachment: [*c]const Attachment) bool {
    ...
    pub fn setTextureName(self: GpuBackend, _handle: TextureHandle, _name: [*c]const u8, _len: i32) void {
        return self.api.setTextureName(self.inst, _handle, _name, _len);
    }
    ...
    pub fn createFrameBufferFromHandles(self: GpuBackend, _num: u8, _handles: [*c]const TextureHandle, _destroyTexture: bool) FrameBufferHandle {
        return self.api.createFrameBufferFromHandles(self.inst, _num, _handles, _destroyTexture);
    }
    pub fn createFrameBufferFromAttachment(self: GpuBackend, _num: u8, _attachment: [*c]const Attachment, _destroyTexture: bool) FrameBufferHandle {
        return self.api.createFrameBufferFromAttachment(self.inst, _num, _attachment, _destroyTexture);
    }
    ...
    pub fn setFrameBufferName(self: GpuBackend, _handle: FrameBufferHandle, _name: [*c]const u8, _len: i32) void {
        return self.api.setFrameBufferName(self.inst, _handle, _name, _len);
    }
    ...
    pub fn createUniform(self: GpuBackend, _name: [*c]const u8, _type: UniformType, _num: u16) UniformHandle {
    ...
    pub fn createOcclusionQuery(self: GpuBackend) OcclusionQueryHandle {
        return self.api.createOcclusionQuery(
            self.inst,
        );
    }
    ...
    pub fn setViewName(self: GpuBackend, _id: ViewId, _name: [*c]const u8, _len: i32) void {
        return self.api.setViewName(self.inst, _id, _name, _len);
    }
    ...
    pub fn setViewOrder(self: GpuBackend, _id: ViewId, _num: u16, _order: [*c]const ViewId) void {
    ...
    pub fn vertexPack(self: GpuBackend, _input: [4]f32, _inputNormalized: bool, _attr: Attrib, _layout: [*c]const VertexLayout, _data: ?*anyopaque, _index: u32) void {
        return self.api.vertexPack(self.inst, _input, _inputNormalized, _attr, _layout, _data, _index);
    }
    pub fn vertexUnpack(self: GpuBackend, _output: [4]f32, _attr: Attrib, _layout: [*c]const VertexLayout, _data: ?*const anyopaque, _index: u32) void {
        return self.api.vertexUnpack(self.inst, _output, _attr, _layout, _data, _index);
    }
    pub fn vertexConvert(self: GpuBackend, _dstLayout: [*c]const VertexLayout, _dstData: ?*anyopaque, _srcLayout: [*c]const VertexLayout, _srcData: ?*const anyopaque, _num: u32) void {
        return self.api.vertexConvert(self.inst, _dstLayout, _dstData, _srcLayout, _srcData, _num);
    }
    pub fn weldVertices(self: GpuBackend, _output: ?*anyopaque, _layout: [*c]const VertexLayout, _data: ?*const anyopaque, _num: u32, _index32: bool, _epsilon: f32) u32 {
...
pub const GpuBackendApi = struct {
    pub fn implement(comptime T: type) GpuBackendApi {
        return GpuBackendApi{
            ...
            .createDefaultOptionsForRenderer = T.createDefaultOptionsForRenderer,
    ...
    createDefaultOptionsForRenderer: *const fn (self: *anyopaque) ShadercOptions,
    ...
    alloc: *const fn (self: *anyopaque, _size: u32) [*c]const Memory,
    copy: *const fn (self: *anyopaque, _data: ?*const anyopaque, _size: u32) [*c]const Memory,
    makeRef: *const fn (self: *anyopaque, _data: ?*const anyopaque, _size: u32) [*c]const Memory,
    makeRefRelease: *const fn (self: *anyopaque, _data: ?*const anyopaque, _size: u32, _releaseFn: ?*anyopaque, _userData: ?*anyopaque) [*c]const Memory,
    ...
    setIndexBufferName: *const fn (self: *anyopaque, _handle: IndexBufferHandle, _name: [*c]const u8, _len: i32) void,
    destroyIndexBuffer: *const fn (self: *anyopaque, _handle: IndexBufferHandle) void,
    createVertexLayout: *const fn (self: *anyopaque, _layout: [*c]const VertexLayout) VertexLayoutHandle,
    destroyVertexLayout: *const fn (self: *anyopaque, _layoutHandle: VertexLayoutHandle) void,
    createVertexBuffer: *const fn (self: *anyopaque, _mem: ?*const Memory, _layout: [*c]const VertexLayout, _flags: BufferFlags) VertexBufferHandle,
    setVertexBufferName: *const fn (self: *anyopaque, _handle: VertexBufferHandle, _name: [*c]const u8, _len: i32) void,
    ...
    createDynamicVertexBuffer: *const fn (self: *anyopaque, _num: u32, _layout: [*c]const VertexLayout, _flags: BufferFlags) DynamicVertexBufferHandle,
    createDynamicVertexBufferMem: *const fn (self: *anyopaque, _mem: ?*const Memory, _layout: [*c]const VertexLayout, _flags: u16) DynamicVertexBufferHandle,
    ...
    getAvailTransientVertexBuffer: *const fn (self: *anyopaque, _num: u32, _layout: [*c]const VertexLayout) u32,
    allocTransientIndexBuffer: *const fn (self: *anyopaque, _tib: [*c]TransientIndexBuffer, _num: u32, _index32: bool) void,
    allocTransientVertexBuffer: *const fn (self: *anyopaque, _tvb: [*c]TransientVertexBuffer, _num: u32, _layout: [*c]const VertexLayout) void,
    allocTransientBuffers: *const fn (self: *anyopaque, _tvb: [*c]TransientVertexBuffer, _layout: [*c]const VertexLayout, _numVertices: u32, _tib: [*c]TransientIndexBuffer, _numIndices: u32, _index32: bool) bool,
    ...
    setShaderName: *const fn (self: *anyopaque, _handle: ShaderHandle, _name: [*c]const u8, _len: i32) void,
    ...
    isFrameBufferValid: *const fn (self: *anyopaque, _num: u8, _attachment: [*c]const Attachment) bool,
    ...
    setTextureName: *const fn (self: *anyopaque, _handle: TextureHandle, _name: [*c]const u8, _len: i32) void,
    ...
    createFrameBufferFromHandles: *const fn (self: *anyopaque, _num: u8, _handles: [*c]const TextureHandle, _destroyTexture: bool) FrameBufferHandle,
    createFrameBufferFromAttachment: *const fn (self: *anyopaque, _num: u8, _attachment: [*c]const Attachment, _destroyTexture: bool) FrameBufferHandle,
    ...
    setFrameBufferName: *const fn (self: *anyopaque, _handle: FrameBufferHandle, _name: [*c]const u8, _len: i32) void,
    ...
    createUniform: *const fn (self: *anyopaque, _name: [*c]const u8, _type: UniformType, _num: u16) UniformHandle,
    ...
    setViewName: *const fn (self: *anyopaque, _id: ViewId, _name: [*c]const u8, _len: i32) void,
    ...
    setViewOrder: *const fn (self: *anyopaque, _id: ViewId, _num: u16, _order: [*c]const ViewId) void,
    resetView: *const fn (self: *anyopaque, _id: ViewId) void,

    layoutBegin: *const fn (self: *VertexLayout) *VertexLayout,
    ...
    layoutHas: *const fn (vl: *const VertexLayout, _attrib: Attrib) bool,
    layoutSkip: *const fn (vl: *VertexLayout, _num: u8) *VertexLayout,
    layoutEnd: *const fn (vl: *VertexLayout) void,

    vertexPack: *const fn (self: *anyopaque, _input: [4]f32, _inputNormalized: bool, _attr: Attrib, _layout: [*c]const VertexLayout, _data: ?*anyopaque, _index: u32) void,
    vertexUnpack: *const fn (self: *anyopaque, _output: [4]f32, _attr: Attrib, _layout: [*c]const VertexLayout, _data: ?*const anyopaque, _index: u32) void,
    vertexConvert: *const fn (self: *anyopaque, _dstLayout: [*c]const VertexLayout, _dstData: ?*anyopaque, _srcLayout: [*c]const VertexLayout, _srcData: ?*const anyopaque, _num: u32) void,
    weldVertices: *const fn (self: *anyopaque, _output: ?*anyopaque, _layout: [*c]const VertexLayout, _data: ?*const anyopaque, _num: u32, _index32: bool, _epsilon: f32) u32,
...
pub const GpuEncoder = struct {
    pub inline fn setMarker(self: GpuEncoder, _name: [*c]const u8, _len: i32) void {
        return self.vtable.SetMarker(self.ptr, _name, _len);
    }
    ...
    pub inline fn setTransientIndexBuffer(self: GpuEncoder, _tib: [*c]const TransientIndexBuffer, _firstIndex: u32, _numIndices: u32) void {
    ...
    pub inline fn setTransientVertexBuffer(self: GpuEncoder, _stream: u8, _tvb: [*c]const TransientVertexBuffer, _startVertex: u32, _numVertices: u32) void {
        return self.vtable.SetTransientVertexBuffer(self.ptr, _stream, _tvb, _startVertex, _numVertices);
    }
    pub inline fn setTransientVertexBufferWithLayout(self: GpuEncoder, _stream: u8, _tvb: [*c]const TransientVertexBuffer, _startVertex: u32, _numVertices: u32, _layoutHandle: VertexLayoutHandle) void {
    ...
    pub const VTable = struct {
        SetMarker: *const fn (self: *anyopaque, _name: [*c]const u8, _len: i32) void,
        ...
        SetTransientIndexBuffer: *const fn (self: *anyopaque, _tib: [*c]const TransientIndexBuffer, _firstIndex: u32, _numIndices: u32) void,
        ...
        SetTransientVertexBuffer: *const fn (self: *anyopaque, _stream: u8, _tvb: [*c]const TransientVertexBuffer, _startVertex: u32, _numVertices: u32) void,
        SetTransientVertexBufferWithLayout: *const fn (self: *anyopaque, _stream: u8, _tvb: [*c]const TransientVertexBuffer, _startVertex: u32, _numVertices: u32, _layoutHandle: VertexLayoutHandle) void,
