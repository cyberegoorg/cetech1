...
pub const Viewport = struct {
    pub fn setSize(self: Viewport, size: [2]f32) void {
        self.vtable.setSize(self.ptr, size);
    }
    pub fn getTexture(self: Viewport) ?gpu.TextureHandle {
        return self.vtable.getTexture(self.ptr);
    }
    pub fn getFb(self: Viewport) ?gpu.FrameBufferHandle {
        return self.vtable.getFb(self.ptr);
    }
    pub fn getSize(self: Viewport) [2]f32 {
        return self.vtable.getSize(self.ptr);
    }
    pub fn getDD(self: Viewport) gfx_dd.Encoder {
        return self.vtable.getDD(self.ptr);
    }
    pub fn setViewMtx(self: Viewport, mtx: [16]f32) void {
        return self.vtable.setViewMtx(self.ptr, mtx);
    }
    pub fn getViewMtx(self: Viewport) [16]f32 {
...
pub const RendererApi = struct {
    ...
    createViewport: *const fn (rg: gfx_rg.RenderGraph, world: ?ecs.World) anyerror!Viewport,
