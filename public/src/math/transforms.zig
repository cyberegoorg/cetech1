...
pub const Quatf = extern struct {
    ...
    pub fn toMat(self: Self) zm.Mat {
        return zm.quatToMat(self.toF32x4());
    }
    ...
    pub fn getAxisX(self: Self) Vec3f {
        return self.rotateVec3(.right);
    }

    pub fn getAxisY(self: Self) Vec3f {
        return self.rotateVec3(.up);
    }

    pub fn getAxisZ(self: Self) Vec3f {
        return self.rotateVec3(.forward);
    }
...
pub const Transform = extern struct {
    ...
    pub fn toMat(self: Self) Mat44f {
        ...
        const rot_model_mat = self.rotation.toMat();
    ...
    pub fn getAxisX(self: Self) Vec3f {
        return self.rotation.rotateVec3(.right);
    }

    pub fn getAxisY(self: Self) Vec3f {
        return self.rotation.rotateVec3(.up);
    }

    pub fn getAxisZ(self: Self) Vec3f {
        return self.rotation.rotateVec3(.forward);
    }
};
