...
pub const DrawList = struct {
    ...
    pub fn getOwnerName(self: DrawList) ?[*:0]const u8 {
    ...
    pub fn pushTextureId(self: DrawList, texture_id: gpu.TextureHandle) void {
    ...
    pub fn getClipRectMin(self: DrawList) [2]f32 {
        return self.vtable.getClipRectMin(
            self.ptr,
        );
    }
    pub fn getClipRectMax(self: DrawList) [2]f32 {
        return self.vtable.getClipRectMax(
            self.ptr,
        );
    }
    pub fn addLine(self: DrawList, args: struct { p1: [2]f32, p2: [2]f32, col: u32, thickness: f32 }) void {
    ...
    pub fn addTextUnformatted(self: DrawList, pos: [2]f32, col: u32, txt: []const u8) void {
        self.vtable.addTextUnformatted(self.ptr, pos, col, txt);
    }
    pub fn addPolyline(self: DrawList, points: []const [2]f32, args: struct {
        col: u32,
        flags: DrawFlags = .{},
        thickness: f32 = 1.0,
    }) void {
    ...
    pub fn addConvexPolyFilled(self: DrawList, points: []const [2]f32, col: u32) void {
    ...
    pub fn addImage(self: DrawList, user_texture_id: gpu.TextureHandle, args: struct {
        pmin: [2]f32,
        pmax: [2]f32,
        uvmin: [2]f32 = .{ 0, 0 },
        uvmax: [2]f32 = .{ 1, 1 },
    ...
    pub fn addImageQuad(self: DrawList, user_texture_id: gpu.TextureHandle, args: struct {
        p1: [2]f32,
        p2: [2]f32,
        p3: [2]f32,
        p4: [2]f32,
    ...
    pub fn addImageRounded(self: DrawList, user_texture_id: gpu.TextureHandle, args: struct {
        pmin: [2]f32,
        pmax: [2]f32,
        uvmin: [2]f32 = .{ 0, 0 },
        uvmax: [2]f32 = .{ 1, 1 },
    ...
    pub fn primRect(self: DrawList, a: [2]f32, b: [2]f32, col: u32) void {
        self.vtable.primRect(self.ptr, a, b, col);
    }
    pub fn primRectUV(self: DrawList, a: [2]f32, b: [2]f32, uv_a: [2]f32, uv_b: [2]f32, col: u32) void {
    ...
    pub fn primQuadUV(self: DrawList, a: [2]f32, b: [2]f32, c: [2]f32, d: [2]f32, uv_a: [2]f32, uv_b: [2]f32, uv_c: [2]f32, uv_d: [2]f32, col: u32) void {
    ...
    pub fn primWriteVtx(self: DrawList, pos: [2]f32, uv: [2]f32, col: u32) void {
        self.vtable.primWriteVtx(self.ptr, pos, uv, col);
    }
    pub fn primWriteIdx(self: DrawList, idx: DrawIdx) void {
